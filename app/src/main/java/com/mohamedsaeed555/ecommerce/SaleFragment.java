...
public class SaleFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Sale Product");
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Database db = new Database(getActivity());
              /*  int amount3 = Integer.parseInt(pamount.getText().toString().trim())* -1 ;
                Toast.makeText(getActivity(),String.valueOf(amount3),Toast.LENGTH_LONG).show();
                                ...
                                .enqueue(new Callback<Void>() {
                                    ...
                                    public void onResponse(Call<Void> call, Response<Void> response) {
                                        ...
                                        if (count == Products.size() - 1) {
                                            ...
                                            btn_ok.setEnabled(true);
                                            btn_ok.setBackgroundColor(Color.GRAY);
                                            Toast.makeText(getActivity(), "Product Sale Successfully", Toast.LENGTH_SHORT).show();
                                        }
